...
class Slider_model extends CI_Model{
	...
	function get_detail($id_content){
		...
		foreach($query2->result() as $row2){
		 $img_url2 = base_url(). 'assets/images/upload/slider/'.$row2->fe_img_files;
        ...
        $blog.='<div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="100ms">
                    ...
                    <article class="media clearfix">
                        ...
                        <div class="media-body">
                            <header class="entry-header">
                                <h4 class="entry-title"><a href="'.base_url().'slider/detail/'.$row2->fe_content_id.'">'.$row2->fe_content_title.'</a></h4>
