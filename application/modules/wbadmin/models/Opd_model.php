...
class Opd_model extends CI_Model{
    ...
    function getRows($params = array()){
	 ...
	 $this->db->from('sys_fe_content');
        ...
        if(!empty($params['search']['keywords'])){
            $likeCriteria = "(fe_content_title  LIKE '%".$params['search']['keywords']."%' OR  fe_content_short_desc  LIKE '%".$params['search']['keywords']."%' OR    sys_page_section.section_name  LIKE '%".$params['search']['keywords']."%') and fe_section_name ='$opd_section_id' ";
	...
	function row_delete($dt){//prepare for image del
