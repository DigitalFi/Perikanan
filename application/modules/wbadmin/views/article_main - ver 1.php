...
.stylish-input-group button{
 ...
 <script>
  ...
  function delete_data(id_value){
    alert(id_value);
    $('#loadingmessage').show(); 
    var url;
    url='delete_selected_article';
    $.post(url, {
            d_value : id_value
        }, function(response){
      alert(response);
...
function delete_data1(){
        ...
        var url = 'delete_selected_article';
...
<div><?php echo $this->pagination->create_links(); ?></div>
  <div class="panel-footer">
   <button type="button"  data-toggle='modal' data-target='#confirm_del' class="btn btn-danger btn-sm">Delete Article</button>
	...
	<button type="button"  onclick="add_article()" id="delete_btn"  class="btn btn-success btn-sm">Add Article</button> 
    </div>
</div>
  ...
  <div class="modal fade" id="confirm_del" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                 <button type="button" onclick="delete_data(document.getElementById('tags').value)" class="btn btn-danger">Yes</button>
