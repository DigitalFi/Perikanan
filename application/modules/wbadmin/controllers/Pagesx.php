...
class Pages extends CI_Controller{
	...
	public function config_menu_fe (){
		if($this->session->userdata('user_id')){
			...
			$data['dt_cbo_article'] = create_chosen_db_combo('sys_fe_content', 'fe_content_id', 'fe_content_title', 'fe_content_id', '-Pages-', $selected_data); //create_db_combo('sys_fe_content', 'fe_content_id', 'fe_content_title', 'fe_content_id', '-Pages-');
