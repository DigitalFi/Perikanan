...
.stylish-input-group button{
 ...
 <script>
  function search_data(search_value){
    $('#loadingmessage').show(); 
    var url;
    url= '<?php echo base_url() ?>pages/page_list';
    $.post(url, {
 ...
 <div class="panel-heading clearfix">
  <div class="row ">
    <div class="box-header">
        ...
        <div class="box-tools">
            <form action="<?php echo base_url() ?>pages/page_list" method="POST" id="searchList">
        ...
        <div class="modal-body">
         <!--modal content start here-->
            ...
            <input type="text" id="hdn_item" name="hdn_item"/>
                ...
                <?php 
                echo '<li class="ui-state-default" id="item-0"><span >Article<span></li>'; 
