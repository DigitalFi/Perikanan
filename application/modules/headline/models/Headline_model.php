...
class Headline_model extends CI_Model{
	...
	function get_detail($id_content){
		...
		$row=$query->row();
		if(isset($row)){
			$img_url = base_url(). 'assets/images/upload/headline/'.$row->fe_img_files;
		...
		foreach($query2->result() as $row2){
		 $img_url2 = base_url(). 'assets/images/upload/headline/'.$row2->fe_img_files;
        ...
        $blog.='<div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="100ms">
                    ...
                    <article class="media clearfix">
                        ...
                        <div class="media-body">
                            <header class="entry-header">
                                <h4 class="entry-title"><a href="'.base_url().'headline/detail/'.$row2->fe_content_id.'">'.$row2->fe_content_title.'</a></h4>
