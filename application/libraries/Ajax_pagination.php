...
class Ajax_pagination{
    ...
    var $last_link       = 'Last';
    var $uri_segment     = 3;
    var $full_tag_open   = '<nav><ul class="pagination pagination-sm">';
    ...
    function create_links(){
        ...
        $output =$this->full_tag_open.$output.$this->full_tag_close.$info;
        ?>
        <script>
        function getData(page){
            document.getElementById('page_pos').value=page;  
            $.ajax({
                method: "POST",
